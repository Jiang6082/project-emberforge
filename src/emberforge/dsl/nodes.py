"""Typed expression-tree nodes for the factor DSL.
...
The tree is deliberately small and closed. Arbitrary Python is never part of
the execution path; a factor is always one of these three node types.
"""
