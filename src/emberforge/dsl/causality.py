...
The causality checks are structural (they inspect the tree, not the data) and
are the first line of leakage defence. Data-driven leakage detection lives in
:mod:`emberforge.compute` and :mod:`emberforge.analytics`.
"""
